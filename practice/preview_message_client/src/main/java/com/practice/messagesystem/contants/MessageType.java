package com.practice.messagesystem.contants;
...
public class MessageType {
    ...
    public static final String REJECT_RESPONSE = "REJECT_RESPONSE";         //요청 거절을 한 것에 대한 응답

    public static final String DISCONNECT_REQUEST = "DISCONNECT_REQUEST";   //채팅 연결 끊기
    public static final String DISCONNECT_RESPONSE = "DISCONNECT_RESPONSE"; //연결을 끊은 것에 대한 응답
